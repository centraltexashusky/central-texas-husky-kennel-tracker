...
if (!index.includes('js/main.js?v=20260722-payroll-compact-scheduler-v2')) failures.push("Application entrypoint does not expose the automatic task identity fix.");
