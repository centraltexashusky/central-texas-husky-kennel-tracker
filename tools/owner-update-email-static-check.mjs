...
if (!main.includes('shared.js?v=20260722-multi-operation-windows')) failures.push("Shared notification handling is not cache-busted.");
...
if (!index.includes('js/main.js?v=20260722-multi-operation-windows')) failures.push("The production module entrypoint is not cache-busted.");
