...
if (!main.includes('shared.js?v=20260720-owner-update-email-delivery')) failures.push("Shared notification handling is not cache-busted.");
...
if (!index.includes('js/main.js?v=20260720-owner-update-email-delivery')) failures.push("The production module entrypoint is not cache-busted.");
