...
if (!main.includes('shared.js?v=20260721-boarding-quick-fact-popups-v2')) failures.push("Shared notification handling is not cache-busted.");
if (!main.includes('boarding.js?v=20260721-boarding-quick-fact-popups-v2')) failures.push("Boarding owner-update handling is not cache-busted.");
if (!index.includes('js/main.js?v=20260721-boarding-quick-fact-popups-v2')) failures.push("The production module entrypoint is not cache-busted.");
