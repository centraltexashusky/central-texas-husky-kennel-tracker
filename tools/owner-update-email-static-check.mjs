...
if (!main.includes('shared.js?v=20260723-profile-ux-fixes-v2')) failures.push("Shared notification handling is not cache-busted.");
...
if (!index.includes('js/main.js?v=20260723-profile-ux-fixes-v2')) failures.push("The production module entrypoint is not cache-busted.");
