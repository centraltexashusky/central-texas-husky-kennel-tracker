...
const required = [
  ...
  ["index.html", 'optional-dog-income-rewards-grouped-ledgers-expense-split', "Dog Show styles are not cache-busted."],
  ...
  ["js/main.js", 'optional-dog-income-rewards-category-sync-grouped-ledgers-expense-split', "Dog Show finance changes are not cache-busted."],
  ["index.html", 'finance-category-sync-grouped-ledgers-expense-split', "Dog Show entrypoint changes are not cache-busted."],
  ...
  ["supabase/functions/show-calendar-scrape/index.ts", 'calendarAssignmentJudge(showHtml, "Siberian Husky")', "The calendar scraper does not read the raw Siberian Husky judge assignment."],
  ...
  ["supabase/functions/show-calendar-scrape/index.ts", 'judgeByAssignment(/^Siberian Husky\\b/i)', "The calendar scraper does not import the Siberian Husky judge."],
  ["supabase/functions/show-calendar-scrape/index.ts", 'panelJudge(panelTitle, "Working Group")', "The calendar scraper does not import Working Group judges."],
