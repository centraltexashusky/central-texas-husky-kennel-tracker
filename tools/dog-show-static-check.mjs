...
const required = [
  ...
  ["index.html", 'grouped-ledgers-expense-split-planner-breed-potential-shows', "Dog Show styles are not cache-busted."],
  ...
  ["js/main.js", 'grouped-ledgers-expense-split-planner-breed-potential-shows', "Dog Show planner changes are not cache-busted."],
  ["index.html", 'grouped-ledgers-expense-split-planner-breed-potential-shows', "Dog Show entrypoint changes are not cache-busted."],
  ...
  ["js/dog-show.js", "totals.expenseTotal / splitCount", "The per-dog expense split is not calculated from total expenses."],
  ["js/dog-show.js", "income and rewards are not subtracted", "The expense split does not explain how income is handled."],
  ...
  ["js/dog-show.js", "metadataVersion: 3", "Fresh Show Planner searches are not marked with the current metadata version."],
  ...
  ["js/dog-show.js", 'const expanded = status === "In Process" || status === "Active"', "Going, Potential Plan, and Completed stages are not collapsed by default."],
  ...
  ["supabase/functions/show-calendar-scrape/index.ts", 'sourceUrl.searchParams.set("fmt", "1")', "The calendar scraper does not request the breed-panel calendar layout."],
  ["supabase/functions/show-calendar-scrape/index.ts", 'sourceUrl.searchParams.delete("month")', "The calendar scraper still limits state searches to Canine Chronicle's Current+2 window."],
  ["supabase/functions/show-calendar-scrape/index.ts", 'sourceUrl.searchParams.set("perf", "conf")', "The calendar scraper does not explicitly request conformation shows."],
  ...
  ["supabase/functions/show-calendar-scrape/index.ts", "return json({ shows, breedCode, breedName", "The calendar scraper does not return the resolved breed metadata."],
