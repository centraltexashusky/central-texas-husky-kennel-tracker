...
const required = [
  ...
  ["index.html", 'styles.css?v=20260720-dog-show-ring-timeline-potty', "Dog Show ring, timeline, and potty styles are not cache-busted."],
  ...
  ["js/main.js", 'dog-show.js?v=20260720-dog-show-ring-timeline-potty', "Dog Show ring, timeline, and potty changes are not cache-busted."],
