...
const required = [
  ...
  ["supabase/functions/show-calendar-scrape/index.ts", "embeddedUrl(showAnchor.getAttribute", "The calendar scraper does not normalize JavaScript popup links."],
  ...
  ["supabase/functions/show-calendar-scrape/index.ts", "showGroupPanel(showHtml, judgeAnchors)", "The calendar scraper does not resolve the selected breed's group judge."],
