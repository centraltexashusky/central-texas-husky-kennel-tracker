...
const required = [
  ...
  ["index.html", 'show-expenses-special-outcomes-v2-show-level-expenses-edit', "Dog Show styles are not cache-busted."],
  ...
  ["js/main.js", 'show-expenses-special-outcomes-v2-show-level-expenses-edit', "Dog Show expense changes are not cache-busted."],
  ["index.html", 'show-expenses-special-outcomes-v2-show-level-expenses-edit', "Dog Show entrypoint changes are not cache-busted."],
  ...
  ["js/dog-show.js", "delete expense.showEntryId", "Edited legacy expenses remain unnecessarily assigned to a dog."],
  ["js/dog-show.js", "Include a dog’s name in the description", "The show-level expense guidance is missing."],
