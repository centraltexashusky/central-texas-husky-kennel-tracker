...
const required = [
  ...
  ["js/dog-show.js", "function dogShowDogAttributableCostTotals", "Dog-assigned business rewards do not also count as attributable dog cost."],
  ["js/dog-show.js", "totals.expenseTotal + totals.incomeTotal", "Attributable dog cost does not include direct expenses and assigned rewards."],
  ["js/dog-show.js", "function dogShowFinanceDogCostSectionHtml", "Compiled periods are missing an individual dog cost section."],
  ["js/dog-show.js", "Assigned rewards remain income for the business", "The dual business-income and dog-cost treatment is not explained."],
  ["js/dog-show.js", "Attributable dog costs", "Compiled finance totals do not expose attributable dog costs."],
