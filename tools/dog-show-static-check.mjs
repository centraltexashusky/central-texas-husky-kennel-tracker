...
const required = [
  ...
  ["index.html", 'styles.css?v=20260716-dog-show-dark-contrast-task-row', "Dog Show dark contrast and task-row styles are not cache-busted."],
  ...
  ["js/main.js", 'dog-show.js?v=20260716-dog-show-dark-contrast-task-row', "Dog Show dark contrast and task-row changes are not cache-busted."],
