...
const required = [
  ...
  ["index.html", 'styles.css?v=20260716-dog-show-opaque-more-menu', "Dog Show opaque More menu styles are not cache-busted."],
  ...
  ["js/main.js", 'dog-show.js?v=20260716-dog-show-opaque-more-menu', "Dog Show opaque More menu changes are not cache-busted."],
