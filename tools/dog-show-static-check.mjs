...
const required = [
  ...
  ["js/main.js", 'import("./dog-show.js', "Dog Show module is not loaded on demand."],
  ["js/main.js", 'owner-update-win-photo-invoice-v37', "Dog Show lifecycle changes are not cache-busted."],
  ["index.html", 'dog-show-lifecycle-owner-update-photo-invoice-v39', "Dog Show lifecycle entrypoint changes are not cache-busted."],
  ...
  ["js/dog-show.js", "data-show-transaction-filter", "Transactions are missing scope filters."],
  ["js/dog-show.js", '<details class="dog-show-expense-group', "Dog Show transaction ledgers are not collapsible."],
  ...
  ["js/dog-show.js", "function dogShowCompiledFinanceHtml", "Dog Show finances are missing the compiled report."],
  ["js/dog-show.js", 'data-finance-period="', "Compiled finances cannot switch between show, week, month, and year."],
  ["js/dog-show.js", 'Show-wide expenses</span><strong>${dogShowExpenseCurrency(showWideTotals.expenseTotal)}', "Compiled finances do not keep show-wide expenses separate."],
  ["js/dog-show.js", 'Dog-specific expenses</span><strong>${dogShowExpenseCurrency(dogTotals.expenseTotal)}', "Compiled finances do not total dog-specific expenses separately."],
  ["js/dog-show.js", "function dogShowDogAttributableCostTotals", "Dog-assigned business rewards are not included in dog-position calculations."],
  ["js/dog-show.js", "totals.expenseTotal - totals.incomeTotal", "Dog reimbursements and rewards do not offset direct dog expenses."],
  ["js/dog-show.js", "function dogShowDogCostPositionHtml", "Dog ledgers cannot distinguish a cost from a credit."],
  ["js/dog-show.js", "Dog cost offset", "Dog-assigned business income is not identified as a dog cost offset."],
  ["js/dog-show.js", "function dogShowFinanceDogCostSectionHtml", "Compiled periods are missing an individual dog cost section."],
  ["js/dog-show.js", "Assigned amounts remain income for the business", "The business-income and dog-cost-offset treatment is not explained."],
  ["js/dog-show.js", "Net dog position", "Compiled finance totals do not expose the net dog position."],
  ["js/dog-show.js", "function dogShowFinanceDogBreakdownHtml", "Compiled finances are missing each dog's cost breakdown."],
  ["js/dog-show.js", "function dogShowFinanceCustomerReports", "Compiled finances are missing customer reports across associated dogs."],
  ["js/dog-show.js", "function dogShowFinanceCustomerLedgers", "Customer reports do not allocate show-wide costs to customer dogs."],
  ["js/dog-show.js", 'data-finance-scope="customer"', "Compiled finances cannot switch to customer reports."],
  ...
  ["js/dog-show.js", "function dogShowFinanceDogGroupKey", "Dog finance reports do not preserve the source dog identity across shows."],
  ["js/dog-show.js", 'data-invoice-scope="${escapeHtml(selection.invoiceScope || "customer")}"', "Customer and dog reports do not expose scoped invoice actions."],
  ["js/dog-show.js", "periodType,", "Dog Show invoices do not retain whether they cover a show, week, month, or year."],
  ["js/dog-show.js", "function dogShowInvoiceState", "Dog Show finance reports do not reconcile already-invoiced charges."],
  ["js/dog-show.js", "billingKeys: [...new Set(lines.flatMap(dogShowInvoiceLineBillingKeys))]", "Dog Show invoices do not persist charge keys needed to prevent duplicate billing across periods."],
  ["js/dog-show.js", 'id="dogShowInvoicePaymentForm"', "Dog Show invoices cannot record a customer payment."],
  ...
  ["js/dog-show.js", 'data-action="open-show-invoice-center">Invoices</button>', "Dog Show Finances is missing the central Invoice button."],
  ["js/dog-show.js", 'id="dogShowInvoiceCenterForm"', "The Invoice button does not open customer/dog and period selection."],
  ["js/dog-show.js", 'id="dogShowInvoiceEditForm"', "Dog Show invoices cannot update their amount or due date."],
  ["js/dog-show.js", 'name="paidAmount"', "Recorded Dog Show payment amounts cannot be corrected."],
  ["js/dog-show.js", 'id="dogShowInvoicePaymentCancelForm"', "Accidental Dog Show payments cannot be cancelled."],
  ["js/dog-show.js", 'action: "Payment Cancelled"', "Payment reversal history is not retained."],
  ["js/dog-show.js", 'id="dogShowInvoiceCancelForm"', "Dog Show invoices cannot be cancelled."],
  ["js/dog-show.js", 'status: "Cancelled"', "Cancelled Dog Show invoices do not persist a cancelled status."],
  ["js/dog-show.js", 'id="dogShowInvoiceDeleteForm"', "Dog Show invoices cannot be deleted."],
  ["js/dog-show.js", 'removed: true, removedAt: timestamp', "Dog Show invoice deletion does not preserve an audit record."],
  ["js/dog-show.js", "amountHistory:", "Invoice amount corrections do not retain history."],
  ["js/shared.js", 'deferred: ["showDayTask", "showCareLog", "showResult", "showInvoice"', "The Dog Shows page does not load persisted invoice and payment records."],
  ["styles.css", ".dog-show-invoice-status.is-paid", "Paid Dog Show invoices are not visually distinguishable."],
  ["styles.css", ".dog-show-invoice-center", "The central Dog Show invoice workflow is not styled."],
  ["styles.css", ".dog-show-invoice-status.is-cancelled", "Cancelled Dog Show invoices are not visually distinguishable."],
  ...
  ["styles.css", ".dog-show-finance-report-group", "Compiled Dog Show finance periods are not styled."],
  ["styles.css", ".dog-show-finance-dog-row", "Per-dog compiled finance rows are not styled."],
  ["styles.css", ".dog-show-finance-dog-cost-section", "Per-period individual dog cost sections are not styled."],
  ...
  ["styles.css", ".dog-show-expense-group > summary", "Collapsible finance ledger headings are not styled."],
  ["js/dog-show.js", "dog-show-expense-table-header", "Finance ledgers are missing table column headings."],
  ["js/dog-show.js", "dog-show-expense-split-result", "The per-dog split is not shown after the split controls."],
  ["styles.css", ".dog-show-expense-table-header", "Finance table headings are not styled."],
  ["styles.css", ".dog-show-expense-cell::before", "Mobile finance rows are missing readable field labels."],
  ["styles.css", ".dog-show-dog-report", "Dog-specific finance reports are not styled."],
  ...
  ["js/dog-show.js", 'status === dogShowPlannerStage ? "" : " hidden"', "Only the selected lifecycle stage should be visible."],
  ...
  ["styles.css", ".dog-show-upcoming-closing.is-attention", "Planned shows do not make the closing date prominent."],
  ["styles.css", ".dog-show-upcoming-status.is-status-going-to", "Upcoming show status controls are not visually differentiated."],
  ["styles.css", ".dog-show-customer-report-card", "Customer finance reports are not styled."],
  ...
  ["js/dog-show.js", '["open-show-calendar", "Show Calendar"]', "Dog Show More is missing the Show Calendar shortcut."],
  ...
  ["js/shared.js", 'dogShowPage: {', "Dog Show remote records are not page-scoped."],
  ...
  ["js/dog-show.js", "appearances logged", "Result progress does not count individual ring appearances."],
  ...
  ["js/dog-show.js", 'name="resultMedia"', "Dog show results cannot attach a win or result photo."],
  ["js/dog-show.js", 'data-action="create-show-invoice"', "Customer show finance periods cannot create an invoice."],
  ["js/dog-show.js", 'notifyIfNeeded(invoice, "dogShowInvoiceSent")', "Dog show invoices are not emailed to the customer."],
...
if (!dogShowSource.includes('return dogShowEvents().filter((event) => event.status !== "Completed")') || !dogShowSource.includes("dogShowEventWeekendGroups(dogShowOperationalEvents())") || !dogShowSource.includes("No open shows")) failures.push("Past shows must remain available for results and billing until explicitly marked Completed.");
...
if (!dogShowSource.includes("function dogShowPlannerLastYearEntriesUrl") || !dogShowSource.includes("index_results.cfm?action=plan&event_number=${encodeURIComponent(eventNumber)}")) failures.push("Planner cards do not build the official AKC event-details URL from the imported event number.");
if (!dogShowSource.includes('>Last Year Entries<span aria-hidden="true">↗</span></a>') || dogShowSource.includes('data-action="open-planner-last-year-entries"') || dogShowSource.includes("function openDogShowPlannerPreviousYearEntries")) failures.push("Last Year Entries must be a compact external AKC link instead of CuddleStay history.");
if (!plannerResultsHtmlSource.includes('<h3>${escapeHtml(show.club || show.name || "Dog Show")}</h3>${dogShowPlannerEventFlagsHtml(show)}')) failures.push("Planner event-format flags are not rendered below the show name.");
if (!dogShowSource.includes('class="dog-show-planner-judge-copy"') || !read("styles.css").includes("grid-template-columns: minmax(0, 1fr) auto")) failures.push("Planner judge summaries are not compact rows with scores aligned at the far right.");
const notificationsSource = read("js/notifications.js");
const sharedSource = read("js/shared.js");
if (!notificationsSource.includes("function ensureDogShowClosingNotifications") || !notificationsSource.includes('new Set(["going to", "potential", "potential plan"])') || !notificationsSource.includes("daysUntilClosing > 7")) failures.push("Going To and Potential shows do not create seven-day daily closing alerts.");
if (!notificationsSource.includes('notification.eventName === "dogShowClosingSoon"') || !notificationsSource.includes("function openDogShowClosingNotification") || !notificationsSource.includes("Mark Booked/Paid")) failures.push("Dog show closing alerts do not open an actionable resolution plan.");
if (!sharedSource.includes('{ key: "dogShowClosingSoon"') || !sharedSource.includes('"dogShowClosingSoon",')) failures.push("Dog show closing alerts are not registered with the regular admin alert system.");
