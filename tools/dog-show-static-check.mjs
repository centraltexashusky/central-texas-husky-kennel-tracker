...
const required = [
  ...
  ["js/main.js", 'dog-show.js?v=20260727-dog-show-regular-oh-awards-show-planner', "Dog Show planner changes are not cache-busted."],
  ...
  ["supabase/functions/show-calendar-scrape/index.ts", "MAX_RANGE_DAYS", "The calendar scraper has no bounded date range."],
