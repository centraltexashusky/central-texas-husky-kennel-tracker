...
const required = [
  ...
  ["index.html", 'show-level-expenses-edit-optional-dog-income-rewards', "Dog Show styles are not cache-busted."],
  ...
  ["js/main.js", 'show-level-expenses-edit-optional-dog-income-rewards', "Dog Show finance changes are not cache-busted."],
  ["index.html", 'show-level-expenses-edit-optional-dog-income-rewards', "Dog Show entrypoint changes are not cache-busted."],
  ...
  ["js/dog-show.js", 'expense.entryType !== "income"', "Dog Show finance totals do not separate costs and rewards."],
