...
const required = [
  ...
  ["index.html", 'styles.css?v=20260723-profile-ux-fixes-v2-operational-flow-dashboard-vaccine-queues-dog-show-timeline-task-edit-modal-daily-report-groups-dog-show-result-tiers-progress-dog-show-regular-oh-awards-show-planner-judge-scores-decisions', "Dog Show styles are not cache-busted."],
  ...
  ["js/main.js", 'dog-show.js?v=20260727-dog-show-regular-oh-awards-show-planner-year-range-judge-scores-decisions', "Dog Show planner changes are not cache-busted."],
  ["index.html", 'js/main.js?v=20260723-customer-file-view-v2-dashboard-simplify-operational-flow-dashboard-vaccine-queues-board-queue-cleanup-dog-show-timeline-task-edit-modal-dashboard-timeline-restore-daily-report-groups-compact-dog-show-result-tiers-progress-dog-show-regular-oh-awards-show-planner-year-range-judge-scores-decisions', "Dog Show entrypoint changes are not cache-busted."],
