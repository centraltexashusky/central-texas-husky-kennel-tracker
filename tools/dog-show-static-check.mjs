...
if (!dogShowSource.includes('data-action="open-planner-last-year-entries"') || !dogShowSource.includes("function openDogShowPlannerPreviousYearEntries")) failures.push("Planner cards do not expose matching prior-year entry history as a compact show link.");
