...
const required = [
  ...
  ["index.html", 'styles.css?v=20260716-dog-show-uniform-bulk-care-social-rings', "Dog Show bulk care and socialization ring visibility styles are not cache-busted."],
  ...
  ["js/main.js", 'dog-show.js?v=20260716-dog-show-uniform-bulk-care-social-rings', "Dog Show bulk care and socialization ring visibility changes are not cache-busted."],
