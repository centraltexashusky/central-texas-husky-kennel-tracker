...
if (!main.includes('shared.js?v=20260723-customer-file-view-v2')) failures.push("Dashboard care behavior is not cache-busted.");
if (!index.includes('styles.css?v=20260723-profile-ux-fixes-v2')
  || !index.includes('js/main.js?v=20260723-customer-file-view-v2')) failures.push("Dashboard care assets are not cache-busted.");
