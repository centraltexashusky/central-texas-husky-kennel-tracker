...
if (!main.includes('shared.js?v=20260722-multi-operation-windows')) failures.push("Dashboard care behavior is not cache-busted.");
if (!index.includes('styles.css?v=20260722-multi-operation-windows')
  || !index.includes('js/main.js?v=20260722-multi-operation-windows')) failures.push("Dashboard care assets are not cache-busted.");
