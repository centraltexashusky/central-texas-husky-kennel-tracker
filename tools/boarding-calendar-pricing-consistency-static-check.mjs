...
if (!boarding.includes("const savedRole = boardingCurrentDogRoleForStay(entry.stay || {}, ratePlan);")) failures.push("Family repricing still trusts the potentially stale summary role.");
