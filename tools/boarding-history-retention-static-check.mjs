...
assert.match(main, /boarding-roster-counts-v89/, "boarding module cache key is current");
assert.match(index, /boarding-roster-counts-v89/, "application entrypoint cache key is current");
