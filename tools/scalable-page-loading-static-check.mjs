...
requireText(shared, "function vaccinationStatusBadgeHtml", "Boarding vaccination badges still depend on a hidden page module.");
if (customer.includes("function vaccinationStatusBadgeHtml")) failures.push("Shared vaccination status code is duplicated in the Customer page chunk.");
