...
const pageModuleLoaders = {
  ...
  timesheet: () => import("./timesheet.js?v=20260829-staff-schedule-sunday-grid-v5-scalable-page-loading-v70"),
...
const pageModuleDependencies = {
  ...
  boardingDogsPage: ["boarding", "settings"],
