// === MODULE: MAIN ===
import "./shared.js?v=20260616-task-scheduler-v1";
import "./auth.js?v=20260610-page-scoped-sync-v2";
import "./customer.js?v=20260611-service-dropoff-v1";
import "./boarding.js?v=20260616-task-scheduler-v1";
import "./daily.js?v=20260615-staff-view-v1";
import "./task-scheduler.js?v=20260616-task-scheduler-v1";
