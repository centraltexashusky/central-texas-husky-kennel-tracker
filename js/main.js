...
import "./shared.js?v=20260723-customer-file-view-v2-dashboard-simplify-operational-flow-dashboard-vaccine-queues-dashboard-timeline-restore-guarded-inline-status-profile-name-persistence-organization-setup-branding-legacy-agreement-profile-resolution";
import "./auth.js?v=20260721-dog-show-nav-user-profile-name-persistence";
import "./customer.js?v=20260722-multi-operation-windows-signed-agreement-profile-email-legacy-agreement-integrity";
...
import "./settings.js?v=20260722-multi-operation-windows-organization-setup-branding-signed-agreement-profile-email-legacy-agreement-profile-resolution";
