...
const pageModuleLoaders = {
  ...
  timesheet: () => import("./timesheet.js?v=20260829-staff-schedule-sunday-grid-v5-scalable-page-loading-v70-time-off-self-service-v91-time-off-upsert-fix-v92-schedule-publish-status-v93-timesheet-workspace-v120"),
