...
// Vaccination status helpers are shared by Customer and Boarding views.
  ...
  try {
    ...
    for (const dog of estimate.dogs) {
      ...
      const payload = {
        ...
        pricingScopeOverride: dogPricingScopeOverride(dog),
        breedDescription: dog.breedDescription,
        ...dogShowRegistrationPatch(dog, existingTarget),
...
await import("./customer-shows.js?v=customer-shows-v139a");
